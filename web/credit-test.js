...
(() => {
  ...
  async function sendAndRead(outEp, inEp, packet, label, expectedCode) {
  ...
  btn.addEventListener('click', async () => {
    ...
    try {
      ...
      await sendAndRead(outEp, inEp, d4Open, 'Open-channel', 0x81);
      await sleep(40);
      await sendAndRead(outEp, inEp, d4CreditGrant, 'Credit grant', 0x83);
      await sleep(40);
      await sendAndRead(outEp, inEp, d4CreditReq, 'Credit request', 0x84);
